...
namespace Crabbing.Scripts.Game
{
    ...
    public delegate void OnTriggerInEvent(GameTrigger gameTrigger, Component actor);
    public delegate void OnTriggerOutEvent(GameTrigger gameTrigger, Component actor);
}